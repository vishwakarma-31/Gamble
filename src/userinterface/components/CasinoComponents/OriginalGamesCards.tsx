...
export default function OrinalGamesCards(props:Props) {
  ...
  return (
    <>   
    <div className='text-lg font-bold p-4 items-center flex gap-2'><FaFireFlameCurved/>OrinalGames</div>
    ...
    <span className='text-[.7rem] px-1 font-bold'>2078 </span><span className='text-[.7rem] font-bold text-slate-400'>Playing</span>
      ...
      <div className=' justify-center flex'> <ViewAllButton name=' Originals' total={total} link='original-game'/></div>
    </>
  );
}