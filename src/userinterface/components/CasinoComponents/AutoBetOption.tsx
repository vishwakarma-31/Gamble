...
function AutoBetOption() {

  const [betAmt,setBetAmt] = useState<number>(0.00)
      const handleChange =(e:React.ChangeEvent<HTMLInputElement>)=>{
        // setBetAmmt(prevNum=>parseFloat((prevNum + 0.01).toFixed(2)));
  ...
  return (
    <>
            <div className='primaryTextColor flex justify-between'>
                ...
                <span className='font-extrabold text-[11px]'>₹0.00</span>

            </div>
        <div className='bg-[#355161] rounded flex items-center group'>
            <input  
