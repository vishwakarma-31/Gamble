...
import RefferedUser from "./RefferedUser";
...
const Affiliate = () => {
    ...
    const menuItems1 = [
        { id: 1, name: "Overview", link: "/affiliate/overview" },
        { id: 2, name: "Campaigns", link: "/affiliate/campaigns" },
        { id: 3, name: "Funds", link: "/affiliate/funds" },
        { id: 4, name: "Referred User", link: "/affiliate/referred-user" },
        { id: 5, name: "FAQ", link: "/affiliate/faq" },
    ];
    useEffect(() => {
        ...
        <div className="flex flex-col md:flex-row w-full bg-[#192b37] justify-start pb-10 sm:gap-3 md:gap-5 lg:gap-7 items-start pt-10">
            ...
            <div className="flex flex-col gap-y-4 w-full md:w-[30%] lg:w-[20%] py-1 justify-center items-start pl-[10px] lg:items-center md:sticky top-10">
                <div className="flex items-center gap-1 justify-center flex-row w-[200px]">
                    <FaCodeBranch color="#d6d6d6" />
                    <div className="text-white font-bold text-[17px]">Affiliate Program</div>
                </div>
            ...
            <div className="flex w-full md:mt-[45px] md:w-[80%] justify-start px-[10px] lg:pr-[50px] md:pr-[25px] xl:pr-[100px] items-start">
                {activeCategory === 1 && <Overview />}
                {activeCategory === 5 && <FAQ />}
                {activeCategory === 2 && <Campaigns />}
                {activeCategory === 3 && <Funds />}
                {activeCategory === 4 && <RefferedUser />}
            </div>
        </div>
    );
};
