...
import { PEG_RADIUS, PLINKO_RAIUS, Plinko as PlinkoGame, PlinkoProps, barrierHeight, barrierWidth, bucketHeight } from './plinko'

import BUMP from '../../assets/sounds/plinko/bump.mp3'
import FALL from '../../assets/sounds/plinko/fall.mp3'
import WIN from '../../assets/sounds/plinko/win.mp3'
...
export default function PlinkoNew() {
